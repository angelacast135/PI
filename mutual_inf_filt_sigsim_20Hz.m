...
%     x = filtfilt(SOS, G, x_raw);
    ...
    x_raw = 5*cos(2*pi*20*t) +randn(1,length(y_raw));
...
save(['./seminario5_MI/hists_2sigs/',signal_name_2,'simsignal20Hz_filt15-40_MI_signal',num2str(k_2),'.mat'], 'str_MI')