...
%     figure
    ...
    subplot(223),title('REV Magnitude-Squared Coherence, HannWin'),xlabel('Frequency (Hz)'),grid
...
%     figure,
    ...
    hold on,
    subplot(224),plot(F_aux,mean_cohere_aux),title('Mean of REV Magnitude-Squared Coherence, HannWin'),xlabel('Frequency (Hz)'),grid %plot(F_aux,mean_cohere_aux),title('Mean of Magnitude-Squared Coherence, HannWin'),xlabel('Frequency (Hz)'),grid
%     pause
end
save(['./seminario5/',signal_name,'_CMC_signal',num2str(k_2),'REV.mat'], 'str_mean_cohere')